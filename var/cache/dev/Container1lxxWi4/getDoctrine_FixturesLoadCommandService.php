...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\BookingFixtures.php';
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\DocumentFixtures.php';
        include_once \dirname(__DIR__, 4).'\\src\\DataFixtures\\TransferFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\BookingFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\DocumentFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\TransferFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []]]);
